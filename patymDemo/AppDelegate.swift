...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var mpcManager: ChatServiceManager!
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        mpcManager = ChatServiceManager()
    ...
    lazy var managedObject: NSManagedObjectModel =
        {
            let modalUrl = Bundle.main.url(forResource: "patymDemo", withExtension: "momd")
            return NSManagedObjectModel(contentsOf: modalUrl!)!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent("PaytmDemo.sqlite")
        var failureReason = "There was an error creating or loading the application's saved data."
        print("Core Data persistentStore url====>\(url)")
        // need for update the core data model, core data migration
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "patymDemo")
